...
\renewcommand{\home}{./Fortran/sources/Foundations} 
 \listings{\home/Sum_series.f90}{function SummationN_n2}
...
\vspace{0.5cm}
\renewcommand{\home}{./Fortran/sources/Foundations} 
 \listings{\home/Sum_series.f90}{function a1}
          {end function}{Sum_series.f90}
...
%\vspace{0.5cm}
%\renewcommand{\home}{./Fortran_project/sources/Foundations} 
% \listings{\home/Sum_Series.f90}{function a1}
%          {end function}{Sum_series.f90}
%
...
\vspace{0.5cm}
\renewcommand{\home}{./Fortran/sources/Foundations} 
 \listings{\home/Sum_series.f90}{function Summation_n2}
          {end function}{Sum_series.f90}
...
\vspace{0.5cm}
\renewcommand{\home}{./Fortran/sources/Foundations} 
 \listings{\home/Sum_Series.f90}{real to avoid overflow}
...
it is done by the following line in the summation example: 
  ...
  \vspace{0.5cm}
  \renewcommand{\home}{./Fortran/sources/Foundations} 
   \listings{\home/Sum_Series.f90}{do while}
...
\vspace{0.5cm}
\renewcommand{\home}{./Fortran/sources/Foundations} 
\listings{\home/Sum_Series.f90}{Summation_n2_examples}
