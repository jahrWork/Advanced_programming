...
\begin{enumerate}[noitemsep]
    ...
    \item Matrices: rectangular arrangement of numbers (or other mathematical objects) distributed in rows and columns.
    \item Graphs: mathematical structures used to model pairwise relations between objects.
\end{enumerate}
...
Sets are usually indicated by listing its elements between curly brackets $\{\}$ separated by commas (roster notation).
...
Sequences and tuples are usually written between parenthesis $()$ or square brackets $[]$.
...
Vectors are usually enclosed in parentheses $()$.
...
Matrices are commonly written with square brackets $[]$.
...
A tensor is usually denoted by a symbolic name followed by a collection of subscripts where the number of subscripts attached defines the rank of the tensor.
...
Graphs are usually denoted enclosed in parenthesis and indicating the sets of vertices and edges. 
