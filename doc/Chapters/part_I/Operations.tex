...
In this first chapter some of the ingredients that conform a programming language are presented. 
Que es un lenguaje de programacion, elementos básicos de la programación
Que es un programa
Que es un algoritmo
