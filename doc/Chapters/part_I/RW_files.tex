...
%-------------------------------
The function \texttt{load\_matrix()} is in charge of reading the data and assigning the data to a local variable \texttt{A}. Contrary to the subroutine, here the dynamic object \texttt{A} needs to be allocated and assigned by hand. 
