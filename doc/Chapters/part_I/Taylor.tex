...
\begin{figure}
    \begin{subfigure}[h]{0.5\textwidth}
        ...
        \caption{Cosine (black) and Taylor expansion with $N = 10$}
        \label{fig:Taylor1}
    \end{subfigure}
    \hspace{\fill}
    \begin{subfigure}[h]{0.5\textwidth}
        ...
        \caption{Function $f(x) = \frac{1}{1-x}$ (black) and Taylor expansion with $N = 5$}
        \label{fig:Taylor2}
    \end{subfigure}    
    ...
    \begin{subfigure}[h]{0.5\textwidth}
        ...
        \caption{Cosine (black) and different Taylor expansions with $N = 1, 5, 9, 13, 17, 21$ and $25$}
        \label{fig:Taylor3}
    \end{subfigure}
