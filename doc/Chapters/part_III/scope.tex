...
Notice that this variable \texttt{x} is considered global within the host function and for all the nested functions. 
We talk about the local scope inside each of the nested functions. 
Each case in the examples is explained in the comments of the code.
...
It indicates to Python that the variable should not be local in the inner function, it does not belong to the inner function.
